    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('log_type', models.CharField(choices=[('Hata', 'Hata'), ('Uyarı', 'Uyarı'), ('Bilgilendirme', 'Bilgilendirme')], max_length=50)),
                ('customer_type', models.CharField(choices=[('Premium', 'Premium'), ('Standard', 'Standard')], max_length=50)),
